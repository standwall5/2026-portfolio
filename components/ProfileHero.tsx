...
const ProfileHero = () => {
  return (
    <div className="flex items-center gap-12">
      <div className="relative w-90 aspect-square rounded-full overflow-hidden border-8 border-(--accent)">
        <Image
          src={profile}
          alt=""
          fill
      ...
      <div className="flex flex-col gap-2 items-center text-center font-bold">
        ...
        <h1 className="text-6xl md:l">
          <span className="text-(--accent) relative">
            John Patrick{" "}
            <Image
              className="absolute opacity-0 sm:opacity-100 sm:-right-15 sm:-top-0 md:opacity-0 rotate-45"
              src={doodle}
              alt=""
              width={100}
              height={100}
        ...
        <div className="social-links flex gap-5 items-center justify-center">
          <a
            ...
            >
              <g clipPath="url(#clip0_730_27126)">
                <path
                  ...
                  fill="var(--accent)"
                  className="group-hover:fill-(--accent-hover) duration-300 ease-out"
                />
              </g>
              <defs>
